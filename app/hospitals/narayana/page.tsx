...
export default function NarayanaPage() {
  return (
    <main className="min-h-screen bg-slate-950 border border-slate-800">
      ...
      <section className="bg-slate-950 text-white py-20">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <Image
            src="/images/narayana.png"
            alt="Narayana Hospitals"
            width={250}
            height={100}
            className="mb-8"
          />
