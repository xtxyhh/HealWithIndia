      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-black via-slate-950 to-blue-950 py-28">
        ...
        <div className="relative max-w-7xl mx-auto px-4 text-center">
          ...
          <div className="flex justify-center gap-5 flex-wrap mt-12">
            ...
            <div className="bg-slate-900 border border-slate-800 rounded-2xl px-8 py-5 min-w-[160px]">
          ...
          <div className="flex justify-center flex-wrap gap-8 mt-10 text-slate-300">
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 text-lg mt-6 max-w-3xl mx-auto">
              ...
              We provide a seamless healthcare journey
              from the first consultation to treatment
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            {features.map((item) => {
              ...
              return (
                ...
                <div
                  key={item.title}
                  className="bg-black border border-slate-800 rounded-[28px] p-8 hover:border-blue-500 transition-all duration-300 hover:shadow-[0_0_40px_rgba(59,130,246,0.15)]"
                >
        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="text-center mb-16">
            ...
            <p className="text-slate-400 text-lg mt-6">
              ...
              A simple and transparent process for international patients.
